...
${frame.code}`;
    ...
    "9b5j7": [
      function (require, module, exports, __globalThis) {
        ...
        var _schemaParserJsDefault =
          parcelHelpers.interopDefault(_schemaParserJs);
        var _formInputExtracterJs = require("../validation/FormInputExtracter.js");
        var _formInputExtracterJsDefault = parcelHelpers.interopDefault(
          _formInputExtracterJs,
        );
        var _inputRulesFactoryJs = require("../validation/InputRulesFactory.js");
        var _inputRulesFactoryJsDefault =
          parcelHelpers.interopDefault(_inputRulesFactoryJs);
        var _singleValidatorJs = require("../validation/SingleValidator.js");
        var _singleValidatorJsDefault =
          parcelHelpers.interopDefault(_singleValidatorJs);
        var _groupValidatorJs = require("../validation/GroupValidator.js");
        var _groupValidatorJsDefault =
          parcelHelpers.interopDefault(_groupValidatorJs);
        var _inputErrorsFactoryJs = require("../validation/InputErrorsFactory.js");
        var _inputErrorsFactoryJsDefault = parcelHelpers.interopDefault(
          _inputErrorsFactoryJs,
        );
        var _validationProcessorJs = require("../validation/ValidationProcessor.js");
        var _validationProcessorJsDefault = parcelHelpers.interopDefault(
          _validationProcessorJs,
        );
        var _formErrorsRendererJs = require("../validation/FormErrorsRenderer.js");
        var _formErrorsRendererJsDefault = parcelHelpers.interopDefault(
          _formErrorsRendererJs,
        );
        var _elementRendererJs = require("../validation/ElementRenderer.js");
        var _elementRendererJsDefault =
          parcelHelpers.interopDefault(_elementRendererJs);
        var _objArgValidatorJs = require("../validation/ObjArgValidator.js");
        var _objArgValidatorJsDefault =
          parcelHelpers.interopDefault(_objArgValidatorJs);
        var _formValidatorJs = require("../validation/FormValidator.js");
        var _formValidatorJsDefault =
          parcelHelpers.interopDefault(_formValidatorJs);
        var _validationSchemaJs = require("../validation/ValidationSchema.js");
        var _validationSchemaJsDefault =
          parcelHelpers.interopDefault(_validationSchemaJs);
        const inputExtracter = new (0, _formInputExtracterJsDefault.default)();
        const inputRulesFactory = new (0,
        _inputRulesFactoryJsDefault.default)();
        const schemaParser = new (0, _schemaParserJsDefault.default)(
          inputExtracter,
          inputRulesFactory,
        );
        const singleValidator = new (0, _singleValidatorJsDefault.default)();
        const groupValidator = new (0, _groupValidatorJsDefault.default)();
        const inputErrorsFactory = new (0,
        _inputErrorsFactoryJsDefault.default)();
        const validationProcessor = new (0,
        _validationProcessorJsDefault.default)(
          singleValidator,
          groupValidator,
          inputErrorsFactory,
        );
        ...
        const formErrorsRenderer = new (0,
        _formErrorsRendererJsDefault.default)(elementRenderer, objArgValidator);
        const formValidator = new (0, _formValidatorJsDefault.default)(
          schemaParser,
          validationProcessor,
          formErrorsRenderer,
          objArgValidator,
      ...
      {
        "../validation/SchemaParser.js": "fvPZA",
        "../validation/FormInputExtracter.js": "3FXNi",
        "../validation/InputRulesFactory.js": "8jwkt",
        "../validation/SingleValidator.js": "3nTCd",
        "../validation/GroupValidator.js": "gZF9b",
        "../validation/InputErrorsFactory.js": "4VgbH",
        "../validation/ValidationProcessor.js": "i8ywZ",
        "../validation/FormErrorsRenderer.js": "jdJ0G",
        "../validation/ElementRenderer.js": "jHJpu",
        "../validation/ObjArgValidator.js": "hqRsY",
        "../validation/FormValidator.js": "8z5on",
        "../validation/ValidationSchema.js": "bUoe4",
    ...
    fvPZA: [
      function (require, module, exports, __globalThis) {
        ...
        var _schemaParserBaseJsDefault =
          parcelHelpers.interopDefault(_schemaParserBaseJs);
        class SchemaParser extends (0, _schemaParserBaseJsDefault.default) {
          constructor(inputExtracter, inputRulesFactory) {
            super();
            if (
              !inputExtracter?.[
                (0, _inputExtracterBaseJs.IS_INPUT_EXTRACTER_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !inputRulesFactory?.[
                (0,
                _inputRulesFactoryBaseJs.IS_INPUT_RULES_FACTORY_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
          ...
          parse(form, schema) {
            if (!(form instanceof HTMLFormElement))
              throw new TypeError(
                "You need to pass a form element to first parameter",
              );
            if (!schema[(0, _validationSchemaJs.IS_VALIDATION_SCHEMA_INSTANCE)])
              throw new TypeError(
                "You need to pass an instance of ValidationSchema",
              );
            ...
            for (let schemaKey of schemaKeys) {
              ...
              if (inputFound) {
                ...
                if (!Array.isArray(inputFound)) {
                  ...
                  const inputRules =
                    this.inputRulesFactory.create(firstGroupInput);
                  inputRules.rules = rules;
                  result.push(inputRules);
                }
              } else
      ...
      {
        "../abstracts/validation/InputExtracterBase.js": "9YZmd",
        "../abstracts/validation/InputRulesFactoryBase.js": "dkt1R",
        "./ValidationSchema.js": "bUoe4",
        "../abstracts/validation/SchemaParserBase.js": "5KxvT",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    "9YZmd": [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_INPUT_EXTRACTER_BASE_INSTANCE",
          () => IS_INPUT_EXTRACTER_BASE_INSTANCE,
        );
        ...
        class InputExtracterBase {
          constructor() {
            if (new.target === InputExtracterBase)
              throw new Error(
                "InputExtracterBase cannot be directly instantiated",
              );
            this[IS_INPUT_EXTRACTER_BASE_INSTANCE] = true;
          }
          getFormInputs() {
            throw new Error(
              "getFormInputs() needs to be implemented in subclass",
            );
          }
        }
    ...
    dkt1R: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_INPUT_RULES_FACTORY_BASE_INSTANCE",
          () => IS_INPUT_RULES_FACTORY_BASE_INSTANCE,
        );
        ...
        class InputRulesFactoryBase {
          constructor() {
            if (new.target === InputRulesFactoryBase)
              throw new Error(
                "InputRulesFactoryBase cannot be instantiated directly",
              );
    ...
    bUoe4: [
      function (require, module, exports, __globalThis) {
        ...
        var _objectUtilsJsDefault =
          parcelHelpers.interopDefault(_objectUtilsJs);
        const IS_VALIDATION_SCHEMA_INSTANCE = Symbol(
          "ValidationSchema/is-instance",
        );
        class ValidationSchema {
          constructor(schemaDef) {
            if (!(0, _objectUtilsJsDefault.default).isPlainObject(schemaDef))
              throw new TypeError(
                "You need to pass a plain object to 1st parameter",
              );
    ...
    "5KxvT": [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_SCHEMA_PARSER_BASE_INSTANCE",
          () => IS_SCHEMA_PARSER_BASE_INSTANCE,
        );
        ...
        class SchemaParserBase {
          constructor() {
            if (new.target === SchemaParserBase)
              throw new Error(
                "You cannot directly instantiate SchemaParserBase",
              );
    ...
    "3FXNi": [
      function (require, module, exports, __globalThis) {
        ...
        var _inputExtracterBaseJs = require("../abstracts/validation/InputExtracterBase.js");
        var _inputExtracterBaseJsDefault = parcelHelpers.interopDefault(
          _inputExtracterBaseJs,
        );
        class FormInputExtracter extends (0,
        _inputExtracterBaseJsDefault.default) {
          constructor() {
            super();
          }
          getFormInputs(form) {
            if (form.tagName !== "FORM")
              throw new TypeError(
                "You need to pass a form element as an argument",
              );
    ...
    "8jwkt": [
      function (require, module, exports, __globalThis) {
        ...
        var _inputRulesFactoryBaseJs = require("../abstracts/validation/InputRulesFactoryBase.js");
        var _inputRulesFactoryBaseJsDefault = parcelHelpers.interopDefault(
          _inputRulesFactoryBaseJs,
        );
        class InputRulesFactory extends (0,
        _inputRulesFactoryBaseJsDefault.default) {
          constructor() {
            super();
          }
          create(input) {
            if (!(0, _typeCheckJsDefault.default).isInputElement(input))
              throw new TypeError(
        ...
        class InputRules {
          ...
          addRule(name, value) {
            if (typeof name !== "string")
              throw new TypeError(
                "First param needs to be of string data type",
              );
            if (
              value === undefined ||
              value === null ||
    ...
    "3nTCd": [
      function (require, module, exports, __globalThis) {
        ...
        var _singleValidatorBaseJsDefault = parcelHelpers.interopDefault(
          _singleValidatorBaseJs,
        );
        ...
        var _typeCheckJs = require("../utils/typeCheck.js");
        var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
        class SingleValidator extends (0,
        _singleValidatorBaseJsDefault.default) {
          constructor() {
            super();
          }
          required(input) {
            if (!(0, _typeCheckJsDefault.default).isSingleInputType(input))
              throw new TypeError(
          ...
          maxLength(input, maxLength) {
            ...
            if (typeof maxLength !== "number" || maxLength <= 0)
              throw new TypeError(
                "Second parameter needs to be a positive number",
              );
            const value = input.value;
            let errorMsg;
      ...
      {
        "../abstracts/validation/SingleValidatorBase.js": "hqYZ4",
        "../utils/arrayUtils.js": "7ZzqY",
        "./InputErrorsFactory.js": "4VgbH",
        "../abstracts/validation/InputErrorsFactoryBase.js": "kxvpz",
        "../utils/typeCheck.js": "b9BKg",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    hqYZ4: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_SINGLE_VALIDATOR_BASE_INSTANCE",
          () => IS_SINGLE_VALIDATOR_BASE_INSTANCE,
        );
        ...
        class SingleValidatorBase {
          ...
          groupInputRequired() {
            throw new Error(
              "groupInputRequired() needs to be implemented in subclass",
            );
          }
        }
    ...
    "7ZzqY": [
      function (require, module, exports, __globalThis) {
        ...
        var _numberUtilsJsDefault =
          parcelHelpers.interopDefault(_numberUtilsJs);
        var _lodash = require("lodash");
        var _lodashDefault = parcelHelpers.interopDefault(_lodash);
        const arrayUtils = {
          getRandItem(array) {
            if (!Array.isArray(array))
              throw new TypeError(
                "First parameter should be of array data type",
              );
            return array[
              (0, _numberUtilsJsDefault.default).generateRandNum(
                0,
                array.length - 1,
              )
            ];
    ...
    "4VgbH": [
      function (require, module, exports, __globalThis) {
        ...
        var _inputErrorsJsDefault =
          parcelHelpers.interopDefault(_inputErrorsJs);
        var _typeCheckJs = require("../utils/typeCheck.js");
        var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
        var _inputErrorsFactoryBaseJs = require("../abstracts/validation/InputErrorsFactoryBase.js");
        var _inputErrorsFactoryBaseJsDefault = parcelHelpers.interopDefault(
          _inputErrorsFactoryBaseJs,
        );
        class InputErrorsFactory extends (0,
        _inputErrorsFactoryBaseJsDefault.default) {
          constructor() {
            super();
          }
          create(input) {
        ...
        class InputErrors {
          ...
          addError(error) {
            if (typeof error !== "string")
              throw new TypeError(
                "You need to pass a string to first parameter",
              );
    ...
    kxvpz: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE",
          () => IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE,
        );
        ...
        class InputErrorsFactoryBase {
          constructor() {
            if (new.target === InputErrorsFactoryBase)
              throw new Error(
                "You cannot directly instantiate InputErrorFactoryBase",
              );
    ...
    gZF9b: [
      function (require, module, exports, __globalThis) {
        ...
        var _groupValidatorBaseJsDefault = parcelHelpers.interopDefault(
          _groupValidatorBaseJs,
        );
      ...
      },
      {
        ...
        "./InputRules.js": "2AXXT",
        "../utils/objectUtils.js": "fhroK",
        "../abstracts/validation/GroupValidatorBase.js": "5Vixr",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    "5Vixr": [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_GROUP_VALIDATOR_BASE_INSTANCE",
          () => IS_GROUP_VALIDATOR_BASE_INSTANCE,
        );
        ...
        class GroupValidatorBase {
          constructor() {
            if (new.target === GroupValidatorBase)
              throw new Error(
                "GroupValidatorBase cannot be instantiated directly",
              );
    ...
    i8ywZ: [
      function (require, module, exports, __globalThis) {
        ...
        var _validationProcessorBaseJsDefault = parcelHelpers.interopDefault(
          _validationProcessorBaseJs,
        );
        class ValidationProcessor extends (0,
        _validationProcessorBaseJsDefault.default) {
          constructor(singleValidator, groupValidator, inputErrorsFactory) {
            super();
            if (
              !singleValidator?.[
                (0, _singleValidatorBaseJs.IS_SINGLE_VALIDATOR_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !groupValidator?.[
                (0, _groupValidatorBaseJs.IS_GROUP_VALIDATOR_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !inputErrorsFactory?.[
                (0,
                _inputErrorsFactoryBaseJs.IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (Array.isArray(inputRulesArray))
              for (let inputRules of inputRulesArray) {
                if (
                  !(
                    inputRules &&
                    inputRules[(0, _inputRulesJs.IS_INPUT_RULES_INSTANCE)]
                  )
                )
                  throw new TypeError(
      ...
      },
      {
        ...
        "../utils/typeCheck.js": "b9BKg",
        "../abstracts/validation/InputErrorsFactoryBase.js": "kxvpz",
        "../abstracts/validation/ValidationProcessorBase.js": "d7Iz7",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    d7Iz7: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_VALIDATION_PROCESSOR_BASE_INSTANCE",
          () => IS_VALIDATION_PROCESSOR_BASE_INSTANCE,
        );
    ...
    jdJ0G: [
      function (require, module, exports, __globalThis) {
        ...
        var _errorsRendererBaseJsDefault = parcelHelpers.interopDefault(
          _errorsRendererBaseJs,
        );
        ...
        class FormErrorsRenderer extends (0,
        _errorsRendererBaseJsDefault.default) {
          constructor(elementRenderer, objArgValidator) {
            super();
            if (
              !elementRenderer?.[
                (0, _elementRendererBaseJs.IS_ELEMENT_RENDERER_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !objArgValidator?.[
                (0, _objArgValidatorBaseJs.IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
          ...
          render(inputErrorsArray, options) {
            if (!Array.isArray(inputErrorsArray))
              ...
              for (let inputErrors of inputErrorsArray) {
                if (!inputErrors[(0, _inputErrorsJs.IS_INPUT_ERRORS_INSTANCE)])
                  throw new TypeError(
                    "You need to pass an array of InputErrors instances",
                  );
              }
      ...
      {
        "../abstracts/validation/ElementRendererBase.js": "cthK1",
        "./InputErrors.js": "7UiLB",
        "../utils/objectUtils.js": "fhroK",
        "../abstracts/validation/ErrorsRendererBase.js": "4OOaJ",
        "../abstracts/validation/SchemaAdataperBase.js": "5jQx6",
        "../abstracts/validation/ObjArgValidatorBase.js": "cVBBJ",
        "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3",
      },
    ],
    cthK1: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_ELEMENT_RENDERER_BASE_INSTANCE",
          () => IS_ELEMENT_RENDERER_BASE_INSTANCE,
        );
        ...
        class ElementRendererBase {
          constructor() {
            if (new.target === ElementRendererBase)
              throw new Error(
                "ElementRendererBase cannot be instantiated directly",
              );
            this[IS_ELEMENT_RENDERER_BASE_INSTANCE] = true;
          }
          createTextElement() {
            throw new Error(
              "createTextElement needs to be implemented in subclass",
            );
          }
        }
    ...
    "4OOaJ": [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.export(
          exports,
          "IS_ERRORS_RENDERER_BASE_INSTANCE",
          () => IS_ERRORS_RENDERER_BASE_INSTANCE,
        );
        ...
        class ErrorsRendererBase {
          constructor() {
            if (new.target === ErrorsRendererBase)
              throw new Error(
                "You cannot directly instantiate ErrorsRendererBase",
              );
    ...
    "5jQx6": [
      function (require, module, exports, __globalThis) {
        ...
        const IS_SCHEMA_ADAPTER_BASE_INSTANCE = Symbol(
          "SchemaAdapterBase/is-instance",
        );
        class SchemaAdapterBase {
          constructor() {
            if (new.target === SchemaAdapterBase)
              throw new Error(
                "SchemaAdapterBase cannot be directly instantiated",
              );
        ...
        class ObjArgValidatorBase {
          constructor() {
            if (new.target === ObjArgValidatorBase)
              throw new Error(
                "ObjArgValidatorBase cannot be directly instantiated",
              );
    ...
    jHJpu: [
      function (require, module, exports, __globalThis) {
        ...
        parcelHelpers.defineInteropFlag(exports);
        var _elementRendererBaseJs = require("../abstracts/validation/ElementRendererBase.js");
        var _elementRendererBaseJsDefault = parcelHelpers.interopDefault(
          _elementRendererBaseJs,
        );
        var _objectUtilsJs = require("../utils/objectUtils.js");
        var _objectUtilsJsDefault =
          parcelHelpers.interopDefault(_objectUtilsJs);
        var _schemaAdataperBaseJs = require("../abstracts/validation/SchemaAdataperBase.js");
        var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
        class ElementRenderer extends (0,
        _elementRendererBaseJsDefault.default) {
          ...
          createTextElement(text, options = {}) {
            if (typeof text !== "string")
              throw new TypeError(
                "First parameter needs to be of string data type",
              );
            const error = this.objArgValidator.options.validate(options);
            if (error) throw error;
            ...
            for (let styleKey of styleKeys) {
              if (newElement.style[styleKey] === undefined)
                throw new TypeError(
                  `${styleKey} is not a valid style property`,
                );
    ...
    hqRsY: [
      function (require, module, exports, __globalThis) {
        ...
        var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
        var _objArgValidatorBaseJsDefault = parcelHelpers.interopDefault(
          _objArgValidatorBaseJs,
        );
        var _schemaAdataperBaseJs = require("../abstracts/validation/SchemaAdataperBase.js");
        const IS_OBJ_ARG_VALIDATOR_INSTANCE = Symbol(
          "ObjArgValidator/is-instance",
        );
        class ObjArgValidator extends (0,
        _objArgValidatorBaseJsDefault.default) {
          constructor(schemaAdapters) {
            super();
            if (!Array.isArray(schemaAdapters)) {
              if (
                !schemaAdapters?.[
                  (0, _schemaAdataperBaseJs.IS_SCHEMA_ADAPTER_BASE_INSTANCE)
                ]
              )
                throw new TypeError(
                  "You need to pass intsance of SchemaAdapterBase",
                );
            } else
      ...
      function (require, module, exports, __globalThis) {
        ...
        class FormValidator {
          constructor(
            ...
            if (
              !schemaParser?.[
                (0, _schemaParserBaseJs.IS_SCHEMA_PARSER_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !validationProcessor?.[
                (0,
                _validationProcessorBaseJs.IS_VALIDATION_PROCESSOR_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
            ...
            if (
              !errorsRenderer?.[
                (0, _errorsRendererBaseJs.IS_ERRORS_RENDERER_BASE_INSTANCE)
              ]
            )
              throw new TypeError(
          ...
          validate(form, schema, options = {}) {
            if (!(form instanceof HTMLFormElement))
              throw new TypeError(
                "You need to pass form element to first parameter",
              );
            if (
              !schema?.[(0, _validationSchemaJs.IS_VALIDATION_SCHEMA_INSTANCE)]
            )
              throw new TypeError(
            ...
            const inputErrorsArray =
              this.validationProcessor.validate(inputRulesArray);
