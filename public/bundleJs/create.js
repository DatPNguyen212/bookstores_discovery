...
})({"gzvXO":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1d51fbe86f51c215";
"use strict";
...
},{}],"9b5j7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _schemaParserJs = require("../validation/SchemaParser.js");
var _schemaParserJsDefault = parcelHelpers.interopDefault(_schemaParserJs);
var _formInputExtracterJs = require("../validation/FormInputExtracter.js");
var _formInputExtracterJsDefault = parcelHelpers.interopDefault(_formInputExtracterJs);
var _inputRulesFactoryJs = require("../validation/InputRulesFactory.js");
var _inputRulesFactoryJsDefault = parcelHelpers.interopDefault(_inputRulesFactoryJs);
var _singleValidatorJs = require("../validation/SingleValidator.js");
var _singleValidatorJsDefault = parcelHelpers.interopDefault(_singleValidatorJs);
var _groupValidatorJs = require("../validation/GroupValidator.js");
var _groupValidatorJsDefault = parcelHelpers.interopDefault(_groupValidatorJs);
var _inputErrorsFactoryJs = require("../validation/InputErrorsFactory.js");
var _inputErrorsFactoryJsDefault = parcelHelpers.interopDefault(_inputErrorsFactoryJs);
var _validationProcessorJs = require("../validation/ValidationProcessor.js");
var _validationProcessorJsDefault = parcelHelpers.interopDefault(_validationProcessorJs);
var _formErrorsRendererJs = require("../validation/FormErrorsRenderer.js");
var _formErrorsRendererJsDefault = parcelHelpers.interopDefault(_formErrorsRendererJs);
var _elementRendererJs = require("../validation/ElementRenderer.js");
var _elementRendererJsDefault = parcelHelpers.interopDefault(_elementRendererJs);
var _objArgValidatorJs = require("../validation/ObjArgValidator.js");
var _objArgValidatorJsDefault = parcelHelpers.interopDefault(_objArgValidatorJs);
var _formValidatorJs = require("../validation/FormValidator.js");
var _formValidatorJsDefault = parcelHelpers.interopDefault(_formValidatorJs);
var _validationSchemaJs = require("../validation/ValidationSchema.js");
var _validationSchemaJsDefault = parcelHelpers.interopDefault(_validationSchemaJs);
const inputExtracter = new (0, _formInputExtracterJsDefault.default)();
const inputRulesFactory = new (0, _inputRulesFactoryJsDefault.default)();
const schemaParser = new (0, _schemaParserJsDefault.default)(inputExtracter, inputRulesFactory);
const singleValidator = new (0, _singleValidatorJsDefault.default)();
const groupValidator = new (0, _groupValidatorJsDefault.default)();
const inputErrorsFactory = new (0, _inputErrorsFactoryJsDefault.default)();
const validationProcessor = new (0, _validationProcessorJsDefault.default)(singleValidator, groupValidator, inputErrorsFactory);
const elementRenderer = new (0, _elementRendererJsDefault.default)();
const objArgValidator = new (0, _objArgValidatorJsDefault.default)();
const formErrorsRenderer = new (0, _formErrorsRendererJsDefault.default)(elementRenderer, objArgValidator);
const formValidator = new (0, _formValidatorJsDefault.default)(schemaParser, validationProcessor, formErrorsRenderer, objArgValidator);
const form = document.querySelector('.form-create');
const schema = new (0, _validationSchemaJsDefault.default)({
    'bookstore[name]': {
        required: true,
        maxLength: 100
    },
...
},{"../validation/SchemaParser.js":"fvPZA","../validation/FormInputExtracter.js":"3FXNi","../validation/InputRulesFactory.js":"8jwkt","../validation/SingleValidator.js":"3nTCd","../validation/GroupValidator.js":"gZF9b","../validation/InputErrorsFactory.js":"4VgbH","../validation/ValidationProcessor.js":"i8ywZ","../validation/FormErrorsRenderer.js":"jdJ0G","../validation/ElementRenderer.js":"jHJpu","../validation/ObjArgValidator.js":"hqRsY","../validation/FormValidator.js":"8z5on","../validation/ValidationSchema.js":"bUoe4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fvPZA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _inputExtracterBaseJs = require("../abstracts/validation/InputExtracterBase.js");
var _inputRulesFactoryBaseJs = require("../abstracts/validation/InputRulesFactoryBase.js");
var _validationSchemaJs = require("./ValidationSchema.js");
var _schemaParserBaseJs = require("../abstracts/validation/SchemaParserBase.js");
var _schemaParserBaseJsDefault = parcelHelpers.interopDefault(_schemaParserBaseJs);
class SchemaParser extends (0, _schemaParserBaseJsDefault.default) {
    constructor(inputExtracter, inputRulesFactory){
        super();
        if (!inputExtracter?.[0, _inputExtracterBaseJs.IS_INPUT_EXTRACTER_BASE_INSTANCE]) throw new TypeError('First parmameter needs an instanceof InputExtracterBase');
        if (!inputRulesFactory?.[0, _inputRulesFactoryBaseJs.IS_INPUT_RULES_FACTORY_BASE_INSTANCE]) throw new TypeError('Second parameter needs to be instanceof InputRulesFactoryBase');
    ...
    parse(form, schema) {
        ...
        if (!schema[0, _validationSchemaJs.IS_VALIDATION_SCHEMA_INSTANCE]) throw new TypeError('You need to pass an instance of ValidationSchema');
...
},{"../abstracts/validation/InputExtracterBase.js":"9YZmd","../abstracts/validation/InputRulesFactoryBase.js":"dkt1R","./ValidationSchema.js":"bUoe4","../abstracts/validation/SchemaParserBase.js":"5KxvT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9YZmd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_INPUT_EXTRACTER_BASE_INSTANCE", ()=>IS_INPUT_EXTRACTER_BASE_INSTANCE);
const IS_INPUT_EXTRACTER_BASE_INSTANCE = Symbol('InputExtracterBase/is-instance');
class InputExtracterBase {
    constructor(){
        if (new.target === InputExtracterBase) throw new Error('InputExtracterBase cannot be directly instantiated');
...
exports.default = InputExtracterBase;
...
},{}],"dkt1R":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_INPUT_RULES_FACTORY_BASE_INSTANCE", ()=>IS_INPUT_RULES_FACTORY_BASE_INSTANCE);
const IS_INPUT_RULES_FACTORY_BASE_INSTANCE = Symbol('InputRulesFactoryBase/is-instance');
class InputRulesFactoryBase {
    constructor(){
        if (new.target === InputRulesFactoryBase) throw new Error('InputRulesFactoryBase cannot be instantiated directly');
...
exports.default = InputRulesFactoryBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bUoe4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_VALIDATION_SCHEMA_INSTANCE", ()=>IS_VALIDATION_SCHEMA_INSTANCE);
var _objectUtilsJs = require("../utils/objectUtils.js");
var _objectUtilsJsDefault = parcelHelpers.interopDefault(_objectUtilsJs);
const IS_VALIDATION_SCHEMA_INSTANCE = Symbol('ValidationSchema/is-instance');
class ValidationSchema {
    constructor(schemaDef){
        if (!(0, _objectUtilsJsDefault.default).isPlainObject(schemaDef)) throw new TypeError('You need to pass a plain object to 1st parameter');
...
},{"../utils/objectUtils.js":"fhroK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fhroK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const objectUtils = {
    isPlainObject (value) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5KxvT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_SCHEMA_PARSER_BASE_INSTANCE", ()=>IS_SCHEMA_PARSER_BASE_INSTANCE);
const IS_SCHEMA_PARSER_BASE_INSTANCE = Symbol('SchemaParserBase/is-instance');
class SchemaParserBase {
    constructor(){
        if (new.target === SchemaParserBase) throw new Error('You cannot directly instantiate SchemaParserBase');
...
exports.default = SchemaParserBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3FXNi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
var _inputExtracterBaseJs = require("../abstracts/validation/InputExtracterBase.js");
var _inputExtracterBaseJsDefault = parcelHelpers.interopDefault(_inputExtracterBaseJs);
class FormInputExtracter extends (0, _inputExtracterBaseJsDefault.default) {
    constructor(){
        super();
    }
    getFormInputs(form) {
        ...
        for(let i = 0; i < elements.length; i++){
            ...
            if (element.tagName === 'INPUT' || element.tagName === 'TEXTAREA' || element.tagName === 'SELECT') {
                for(let j = 0; j < result.length; j++){
                    ...
                    if (!(0, _lodashDefault.default).isArray(itemInResult)) {
...
exports.default = FormInputExtracter;

},{"lodash":"3qBDj","../abstracts/validation/InputExtracterBase.js":"9YZmd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports,__globalThis) {
/**
 * @license
...
},{}],"8jwkt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _inputRulesJs = require("./InputRules.js");
var _inputRulesJsDefault = parcelHelpers.interopDefault(_inputRulesJs);
var _typeCheckJs = require("../utils/typeCheck.js");
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
var _inputRulesFactoryBaseJs = require("../abstracts/validation/InputRulesFactoryBase.js");
var _inputRulesFactoryBaseJsDefault = parcelHelpers.interopDefault(_inputRulesFactoryBaseJs);
class InputRulesFactory extends (0, _inputRulesFactoryBaseJsDefault.default) {
    constructor(){
        super();
    }
    create(input) {
        if (!(0, _typeCheckJsDefault.default).isInputElement(input)) throw new TypeError('You need to pass an input element to first parameter');
        return new (0, _inputRulesJsDefault.default)(input);
    }
}
exports.default = InputRulesFactory;

},{"./InputRules.js":"2AXXT","../utils/typeCheck.js":"b9BKg","../abstracts/validation/InputRulesFactoryBase.js":"dkt1R","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2AXXT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_INPUT_RULES_INSTANCE", ()=>IS_INPUT_RULES_INSTANCE);
var _typeCheckJs = require("../utils/typeCheck.js");
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
const IS_INPUT_RULES_INSTANCE = Symbol('InputRules/is-instance');
class InputRules {
    constructor(input){
        if (!(0, _typeCheckJsDefault.default).isInputElement(input)) throw new TypeError('You need to pass either an input element, select element or textarea element');
        this.input = input;
        this.rules = {};
...
exports.default = InputRules;

},{"../utils/typeCheck.js":"b9BKg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b9BKg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const typeCheck = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3nTCd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _singleValidatorBaseJs = require("../abstracts/validation/SingleValidatorBase.js");
var _singleValidatorBaseJsDefault = parcelHelpers.interopDefault(_singleValidatorBaseJs);
var _arrayUtilsJs = require("../utils/arrayUtils.js");
var _arrayUtilsJsDefault = parcelHelpers.interopDefault(_arrayUtilsJs);
var _inputErrorsFactoryJs = require("./InputErrorsFactory.js");
var _inputErrorsFactoryJsDefault = parcelHelpers.interopDefault(_inputErrorsFactoryJs);
var _inputErrorsFactoryBaseJs = require("../abstracts/validation/InputErrorsFactoryBase.js");
var _typeCheckJs = require("../utils/typeCheck.js");
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
class SingleValidator extends (0, _singleValidatorBaseJsDefault.default) {
    constructor(){
        super();
    }
    required(input) {
        if (!(0, _typeCheckJsDefault.default).isSingleInputType(input)) throw new TypeError('You need to pass single input type element to the function, NOT group input type element');
    ...
    maxLength(input, maxLength) {
        if (!(0, _typeCheckJsDefault.default).isSingleInputType(input)) throw new TypeError('First parameter needs to be a single input type element, NOT group input type element');
    ...
    minLength(input, minLength) {
        if (!(0, _typeCheckJsDefault.default).isSingleInputType(input)) throw new TypeError('You need to pass a single input element to first parameter');
...
exports.default = SingleValidator;

},{"../abstracts/validation/SingleValidatorBase.js":"hqYZ4","../utils/arrayUtils.js":"7ZzqY","./InputErrorsFactory.js":"4VgbH","../abstracts/validation/InputErrorsFactoryBase.js":"kxvpz","../utils/typeCheck.js":"b9BKg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hqYZ4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_SINGLE_VALIDATOR_BASE_INSTANCE", ()=>IS_SINGLE_VALIDATOR_BASE_INSTANCE);
const IS_SINGLE_VALIDATOR_BASE_INSTANCE = Symbol('SingleValidatorBase/is-instance');
class SingleValidatorBase {
    constructor(){
        if (new.target === SingleValidatorBase) throw new Error('ValidatorBase cannot be instantiated directly');
...
exports.default = SingleValidatorBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7ZzqY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _numberUtilsJs = require("./numberUtils.js");
var _numberUtilsJsDefault = parcelHelpers.interopDefault(_numberUtilsJs);
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
const arrayUtils = {
    getRandItem (array) {
        if (!Array.isArray(array)) throw new TypeError('First parameter should be of array data type');
        return array[(0, _numberUtilsJsDefault.default).generateRandNum(0, array.length - 1)];
    },
    ...
    isValueInArray (value, array) {
        ...
        for (let item of array){
            if ((0, _lodashDefault.default).isEqual(value, item)) return true;
        }
        return false;
    },
...
},{"./numberUtils.js":"6FU9B","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6FU9B":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const numberUtils = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4VgbH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _inputErrorsJs = require("./InputErrors.js");
var _inputErrorsJsDefault = parcelHelpers.interopDefault(_inputErrorsJs);
var _typeCheckJs = require("../utils/typeCheck.js");
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
var _inputErrorsFactoryBaseJs = require("../abstracts/validation/InputErrorsFactoryBase.js");
var _inputErrorsFactoryBaseJsDefault = parcelHelpers.interopDefault(_inputErrorsFactoryBaseJs);
class InputErrorsFactory extends (0, _inputErrorsFactoryBaseJsDefault.default) {
    constructor(){
        super();
    }
    create(input) {
        if (!(0, _typeCheckJsDefault.default).isInputElement(input)) throw new TypeError('You need to pass an input element in first parameter');
        return new (0, _inputErrorsJsDefault.default)(input);
    }
}
exports.default = InputErrorsFactory;

},{"./InputErrors.js":"7UiLB","../utils/typeCheck.js":"b9BKg","../abstracts/validation/InputErrorsFactoryBase.js":"kxvpz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7UiLB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_INPUT_ERRORS_INSTANCE", ()=>IS_INPUT_ERRORS_INSTANCE);
var _typeCheckJs = require("../utils/typeCheck.js");
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
...
},{"../utils/typeCheck.js":"b9BKg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kxvpz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE", ()=>IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE);
const IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE = Symbol('InputErrorsFactoryBase/is-instance');
class InputErrorsFactoryBase {
    constructor(){
        if (new.target === InputErrorsFactoryBase) throw new Error('You cannot directly instantiate InputErrorFactoryBase');
...
exports.default = InputErrorsFactoryBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gZF9b":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _inputErrorsFactoryBaseJs = require("../abstracts/validation/InputErrorsFactoryBase.js");
var _inputRulesJs = require("./InputRules.js");
var _objectUtilsJs = require("../utils/objectUtils.js");
var _objectUtilsJsDefault = parcelHelpers.interopDefault(_objectUtilsJs);
var _groupValidatorBaseJs = require("../abstracts/validation/GroupValidatorBase.js");
var _groupValidatorBaseJsDefault = parcelHelpers.interopDefault(_groupValidatorBaseJs);
class GroupValidator extends (0, _groupValidatorBaseJsDefault.default) {
    constructor(){
        super();
    }
    required(input) {
...
},{"../abstracts/validation/InputErrorsFactoryBase.js":"kxvpz","./InputRules.js":"2AXXT","../utils/objectUtils.js":"fhroK","../abstracts/validation/GroupValidatorBase.js":"5Vixr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Vixr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_GROUP_VALIDATOR_BASE_INSTANCE", ()=>IS_GROUP_VALIDATOR_BASE_INSTANCE);
const IS_GROUP_VALIDATOR_BASE_INSTANCE = Symbol('GroupValidatorBase/is-instance');
class GroupValidatorBase {
    constructor(){
        if (new.target === GroupValidatorBase) throw new Error('GroupValidatorBase cannot be instantiated directly');
...
exports.default = GroupValidatorBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i8ywZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _singleValidatorBaseJs = require("../abstracts/validation/SingleValidatorBase.js");
var _groupValidatorBaseJs = require("../abstracts/validation/GroupValidatorBase.js");
...
var _typeCheckJsDefault = parcelHelpers.interopDefault(_typeCheckJs);
var _inputErrorsFactoryBaseJs = require("../abstracts/validation/InputErrorsFactoryBase.js");
var _validationProcessorBaseJs = require("../abstracts/validation/ValidationProcessorBase.js");
var _validationProcessorBaseJsDefault = parcelHelpers.interopDefault(_validationProcessorBaseJs);
class ValidationProcessor extends (0, _validationProcessorBaseJsDefault.default) {
    constructor(singleValidator, groupValidator, inputErrorsFactory){
        super();
        if (!singleValidator?.[0, _singleValidatorBaseJs.IS_SINGLE_VALIDATOR_BASE_INSTANCE]) throw new TypeError('You need to pass instance of SingleValidatorBase to first parameter');
        if (!groupValidator?.[0, _groupValidatorBaseJs.IS_GROUP_VALIDATOR_BASE_INSTANCE]) throw new TypeError('You need to pass instance of GroupValidatorBase in 2nd parameter');
        if (!inputErrorsFactory?.[0, _inputErrorsFactoryBaseJs.IS_INPUT_ERRORS_FACTORY_BASE_INSTANCE]) throw new TypeError('You need to pass instance of InputErrorsFactoryBase in 3rd parameter');
    ...
    validate(inputRulesArray) {
        if (Array.isArray(inputRulesArray)) for (let inputRules of inputRulesArray){
            if (!(inputRules && inputRules[0, _inputRulesJs.IS_INPUT_RULES_INSTANCE])) throw new TypeError('You need to pass an array of instances of InputRules in 2nd parameter');
        }
        ...
        for (let inputRules of inputRulesArray){
            ...
            if ((0, _typeCheckJsDefault.default).isSingleInputType(input)) for (let rule of rules){
...
},{"../abstracts/validation/SingleValidatorBase.js":"hqYZ4","../abstracts/validation/GroupValidatorBase.js":"5Vixr","./InputRules.js":"2AXXT","../utils/typeCheck.js":"b9BKg","../abstracts/validation/InputErrorsFactoryBase.js":"kxvpz","../abstracts/validation/ValidationProcessorBase.js":"d7Iz7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d7Iz7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_VALIDATION_PROCESSOR_BASE_INSTANCE", ()=>IS_VALIDATION_PROCESSOR_BASE_INSTANCE);
const IS_VALIDATION_PROCESSOR_BASE_INSTANCE = Symbol('ValidationProcessorBase/is-instance');
class ValidationProcessorBase {
    constructor(){
        if (new.target === ValidationProcessorBase) throw new Error('You cannot directly instantiate ValidationProcessorBase');
...
exports.default = ValidationProcessorBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jdJ0G":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _elementRendererBaseJs = require("../abstracts/validation/ElementRendererBase.js");
var _inputErrorsJs = require("./InputErrors.js");
var _objectUtilsJs = require("../utils/objectUtils.js");
var _objectUtilsJsDefault = parcelHelpers.interopDefault(_objectUtilsJs);
var _errorsRendererBaseJs = require("../abstracts/validation/ErrorsRendererBase.js");
var _errorsRendererBaseJsDefault = parcelHelpers.interopDefault(_errorsRendererBaseJs);
var _schemaAdataperBaseJs = require("../abstracts/validation/SchemaAdataperBase.js");
var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
class FormErrorsRenderer extends (0, _errorsRendererBaseJsDefault.default) {
    constructor(elementRenderer, objArgValidator){
        super();
        if (!elementRenderer?.[0, _elementRendererBaseJs.IS_ELEMENT_RENDERER_BASE_INSTANCE]) throw new TypeError('You need to pass an isntance of ElementRendererBase to constructor');
        if (!objArgValidator?.[0, _objArgValidatorBaseJs.IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE]) throw new TypeError('You need to pass instance of ObjArgValidatorBase to 2nd parameter');
    ...
    render(inputErrorsArray, options) {
        if (!Array.isArray(inputErrorsArray)) throw new TypeError('You need to pass an array of InputErrors instances');
            ...
            if (!inputErrors[0, _inputErrorsJs.IS_INPUT_ERRORS_INSTANCE]) throw new TypeError('You need to pass an array of InputErrors instances');
        }
...
exports.default = FormErrorsRenderer;

},{"../abstracts/validation/ElementRendererBase.js":"cthK1","./InputErrors.js":"7UiLB","../utils/objectUtils.js":"fhroK","../abstracts/validation/ErrorsRendererBase.js":"4OOaJ","../abstracts/validation/SchemaAdataperBase.js":"5jQx6","../abstracts/validation/ObjArgValidatorBase.js":"cVBBJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cthK1":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_ELEMENT_RENDERER_BASE_INSTANCE", ()=>IS_ELEMENT_RENDERER_BASE_INSTANCE);
const IS_ELEMENT_RENDERER_BASE_INSTANCE = Symbol('ElementRendererBase/is-instance');
class ElementRendererBase {
    constructor(){
        if (new.target === ElementRendererBase) throw new Error('ElementRendererBase cannot be instantiated directly');
...
exports.default = ElementRendererBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4OOaJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_ERRORS_RENDERER_BASE_INSTANCE", ()=>IS_ERRORS_RENDERER_BASE_INSTANCE);
const IS_ERRORS_RENDERER_BASE_INSTANCE = Symbol('ErrorsRendererBase/is-instance');
class ErrorsRendererBase {
    constructor(){
        if (new.target === ErrorsRendererBase) throw new Error('You cannot directly instantiate ErrorsRendererBase');
...
exports.default = ErrorsRendererBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5jQx6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_SCHEMA_ADAPTER_BASE_INSTANCE", ()=>IS_SCHEMA_ADAPTER_BASE_INSTANCE);
const IS_SCHEMA_ADAPTER_BASE_INSTANCE = Symbol('SchemaAdapterBase/is-instance');
class SchemaAdapterBase {
    constructor(){
        if (new.target === SchemaAdapterBase) throw new Error('SchemaAdapterBase cannot be directly instantiated');
...
exports.default = SchemaAdapterBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cVBBJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE", ()=>IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE);
const IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE = Symbol('ObjArgValidatorBase/is-instance');
class ObjArgValidatorBase {
    constructor(){
        if (new.target === ObjArgValidatorBase) throw new Error('ObjArgValidatorBase cannot be directly instantiated');
        this[IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE] = true;
    }
}
exports.default = ObjArgValidatorBase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jHJpu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _elementRendererBaseJs = require("../abstracts/validation/ElementRendererBase.js");
var _elementRendererBaseJsDefault = parcelHelpers.interopDefault(_elementRendererBaseJs);
var _objectUtilsJs = require("../utils/objectUtils.js");
var _objectUtilsJsDefault = parcelHelpers.interopDefault(_objectUtilsJs);
var _schemaAdataperBaseJs = require("../abstracts/validation/SchemaAdataperBase.js");
var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
class ElementRenderer extends (0, _elementRendererBaseJsDefault.default) {
    constructor(objArgValidator){
        super();
        if (!objArgValidator?.[0, _objArgValidatorBaseJs.IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE]) throw new TypeError('You need to pass instance of ObjArgValidatorBase to constructor');
        this.objArgValidator = objArgValidator;
    }
...
},{"../abstracts/validation/ElementRendererBase.js":"cthK1","../utils/objectUtils.js":"fhroK","../abstracts/validation/SchemaAdataperBase.js":"5jQx6","../abstracts/validation/ObjArgValidatorBase.js":"cVBBJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hqRsY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IS_OBJ_ARG_VALIDATOR_INSTANCE", ()=>IS_OBJ_ARG_VALIDATOR_INSTANCE);
var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
var _objArgValidatorBaseJsDefault = parcelHelpers.interopDefault(_objArgValidatorBaseJs);
var _schemaAdataperBaseJs = require("../abstracts/validation/SchemaAdataperBase.js");
const IS_OBJ_ARG_VALIDATOR_INSTANCE = Symbol('ObjArgValidator/is-instance');
class ObjArgValidator extends (0, _objArgValidatorBaseJsDefault.default) {
    constructor(schemaAdapters){
        super();
        if (!Array.isArray(schemaAdapters)) {
            if (!schemaAdapters?.[0, _schemaAdataperBaseJs.IS_SCHEMA_ADAPTER_BASE_INSTANCE]) throw new TypeError('You need to pass intsance of SchemaAdapterBase');
        } else for (let schemaAdapter of schemaAdapters){
            if (!schemaAdapter?.[0, _schemaAdataperBaseJs.IS_SCHEMA_ADAPTER_BASE_INSTANCE]) throw new TypeError('Your array items need to be ALL isntances of SchemaAdapterBase');
        }
...
exports.default = ObjArgValidator;

},{"../abstracts/validation/ObjArgValidatorBase.js":"cVBBJ","../abstracts/validation/SchemaAdataperBase.js":"5jQx6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8z5on":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _errorsRendererBaseJs = require("../abstracts/validation/ErrorsRendererBase.js");
var _objArgValidatorBaseJs = require("../abstracts/validation/ObjArgValidatorBase.js");
...
class FormValidator {
    constructor(schemaParser, validationProcessor, errorsRenderer, objArgValidator){
        if (!schemaParser?.[0, _schemaParserBaseJs.IS_SCHEMA_PARSER_BASE_INSTANCE]) throw new TypeError('You need to pass instance of SchemaParserBase to 1st param');
        if (!validationProcessor?.[0, _validationProcessorBaseJs.IS_VALIDATION_PROCESSOR_BASE_INSTANCE]) throw new TypeError('You need to pass instance of ValidationProcessorBase to 2nd parameter');
        if (!errorsRenderer?.[0, _errorsRendererBaseJs.IS_ERRORS_RENDERER_BASE_INSTANCE]) throw new TypeError('You need to pass instance of ErrorsRendererBase to 3rd parameter');
        if (!objArgValidator?.[0, _objArgValidatorBaseJs.IS_OBJ_ARG_VALIDATOR_BASE_INSTANCE]) throw new TypeError('You need to pass an instance of ObjArgValidatorBase to 4th parameter');
    ...
    validate(form, schema, options = {}) {
        ...
        if (!schema?.[0, _validationSchemaJs.IS_VALIDATION_SCHEMA_INSTANCE]) throw new TypeError('You need to pass instance of ValidationSchema to 2nd parameter');
        const error = this.objArgValidator.options.validate(options);
        if (error) throw error;
        const defaultOptions = {
            tagName: 'div',
...
},{"../abstracts/validation/ErrorsRendererBase.js":"4OOaJ","../abstracts/validation/ObjArgValidatorBase.js":"cVBBJ","../abstracts/validation/SchemaParserBase.js":"5KxvT","../abstracts/validation/ValidationProcessorBase.js":"d7Iz7","./ValidationSchema.js":"bUoe4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gzvXO","9b5j7"], "9b5j7", "parcelRequireb272", {})
