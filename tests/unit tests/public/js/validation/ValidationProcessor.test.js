...
describe('ValidationProcessor', () => {
  ...
  describe('validationProcessor.checkNoErrors())', () => {
    it('when you pass a non array of InputErrors instances, it should throw an error', () => {
      const inputErrorsArray = 3

      const fn = () => {
        validationProcessor.checkNoErrors(inputErrorsArray)
      }

      expect(fn).toThrow(
        'You need to pass an array that contains InputErrors instances'
      )
    })

    it('when you pass an array that contains atleast one item that is not instance of InputErrors, it should throw an error', () => {
      document.body.innerHTML = `<input type = "text" id = "test">`
      const input = document.querySelector('#test')
      const inputErrors = new InputErrors(input)
      const inputErrorsArray = [3, inputErrors]
    ...
    it('when you pass null, it should throw an error', () => {
      const inputErrorsArray = null
    ...
    it('when you pass inputErrorsArray where all inputErrors.errors arrays only have null values, it should return true', () => {
      // Arrange
      document.body.innerHTML = `<form>
          <input type = "text" required value = "3" id = "input1">
          <input type = "text" required value = "3" id = "input2">
      ...
      inputErrors1.errors.push(null)
      inputErrors1.errors.push(null)

      const inputErrors2 = new InputErrors(input2)
      inputErrors2.errors.push(null)
      inputErrors2.errors.push(null)

      const inputErrorsArray = [inputErrors1, inputErrors2]
      console.log(inputErrorsArray)

      // Act
      const result = validationProcessor.checkNoErrors(inputErrorsArray)

      // Assert
      expect(result).toBe(true)
    })

    it("when you pass an inputErrorsArray where there's atleast one inputErrors.errors that doesn't contain all null values, it should return false", () => {
      // Arrange
      document.body.innerHTML = `<form>
          <input type = "text" required value = "3" id = "input1">
      ...
      const inputErrors2 = new InputErrors(input2)
      inputErrors2.errors.push(null)
      inputErrors2.errors.push('value is required')
